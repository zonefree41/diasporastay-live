...
export default function GuestRegister() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            const res = await api.post("/api/guests/register", {
                name,
                email,
                password,
            });
        ...
        <div className="auth-wrapper d-flex justify-content-center align-items-center py-5">
            ...
            >
                <div className="text-center mb-4">
                    <FaUserCircle className="auth-icon-gold" />
                    <h2 className="fw-bold text-gold mt-2">Guest Registration</h2>
                    <p className="text-muted small">
                        Create your DiasporaStay guest account.
                    </p>
                </div>
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <button
                        className="btn premium-btn-filled-gold w-100 mt-3"
                        type="submit"
                        disabled={loading}
                    >
                ...
                <p className="text-center mt-3">
                    ...
                    <Link className="premium-link fw-semibold" to="/guest/login">
                        Login
                    </Link>
                </p>
            </div>
